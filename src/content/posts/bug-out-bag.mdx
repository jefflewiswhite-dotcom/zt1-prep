...
products: ["sawyer-squeeze", "sol-emergency-bivvy", "streamlight-protac", "leatherman-wave-plus", "surviveware-large-first-aid", "datrex-emergency-food-bars", "midland-er310"]
---
...
[Best Emergency Radios →](/gear/best-emergency-radios)
...
<Checklist
  ...
  items={[
    ...
    { item: "Water filter", priority: "essential" },
    { item: "Purification tablets", priority: "recommended" },
    { item: "Emergency bivvy or sleeping bag", priority: "essential" },
    { item: "Tarp or emergency shelter", priority: "recommended" },
    { item: "Paracord (50 ft)", priority: "recommended" },
    { item: "Lighter in waterproof case", priority: "essential" },
    { item: "Ferro rod (backup)", priority: "recommended" },
    { item: "Fire tinder", priority: "recommended" },
    { item: "Flashlight", priority: "essential" },
    { item: "Headlamp", priority: "recommended" },
    { item: "Extra batteries", priority: "essential" },
    { item: "First aid kit", priority: "essential" },
    { item: "Personal medications", priority: "essential" },
    { item: "Knife or multitool", priority: "essential" },
    { item: "Duct tape", priority: "recommended" },
    { item: "Emergency food (2,400+ calories)", priority: "essential" },
    { item: "Regional maps", priority: "recommended" },
    { item: "Compass", priority: "optional" },
    { item: "Emergency radio", priority: "recommended" },
